...
%\usepackage[breaklinks=true, pdfstartview=FitV]{hyperref}
\usepackage{minted}
\usepackage{hyperref}
%\usepackage{caption}
...
\newtoggle{inminted}
\newunicodechar{²}{\iftoggle{inminted}{²}{^2}}
\newunicodechar{δ}{\iftoggle{inminted}{δ}{\delta}}
\newunicodechar{κ}{\iftoggle{inminted}{κ}{$\kappa$}}
\newunicodechar{χ}{\iftoggle{inminted}{χ}{$\xi$}}
\newunicodechar{ξ}{\iftoggle{inminted}{ξ}{$\chi$}}
\newunicodechar{ϵ}{\iftoggle{inminted}{ϵ}{\epsilon}}
\newunicodechar{σ}{\iftoggle{inminted}{σ}{\sigma}}
\newunicodechar{Θ}{\iftoggle{inminted}{Θ}{\Theta}}
...
%\begin{minted}[mathescape,               numbersep=2pt,               gobble=2,               fontsize=\small,               framesep=1mm]{scala}
% val δr =  ϵ3 * p * ξ
% val δR =  ϵ3 * (Θ/r) * (1 + κ) * χ
% val δΘ =  ϵ3 * Θ * (κ*ξ - σ*χ)
%\end{minted}
