...
\begin{enumerate}
  ...
  \item  Access to other variable results besides cartesian results can be used within other algorithms like those performing space debris conjunction analysis
\end{enumerate}
