...
class KeplerAndTrueAnomalyTest extends FunSuite  {
  ...
  test("Kepler equation solving followed by True Anomaly test, inputs in degrees ") {
    ...
    val all =  List( // M, E, f, r 
          (0.0, 0.0, 0.0, 9800.0)
        , (20.0, 20.399423333349958, 20.802664870651377, 9812.542900454288)
        , (90.0, 91.1456865064012, 92.2912203675837, 10004.0)
        , (180.0, 180.0, 180.0, 10200.0)
        , (270.0, 268.8543134935988, -92.29122036758375, 10004.0)
        , (360.0, 360.0, 0.0, 9800.0)
        , (450.0, 451.1456865064012, 92.29122036758375, 10004.0)
        , (-20.0, -20.399423333349958, -20.802664870651377, 9812.542900454288)
        , (-90.0, -91.1456865064012, -92.29122036758375, 10004.0)
        , (-180.0, -180.0, -180.0, 10200.0)
        , (-270.0, -268.8543134935988, 92.2912203675837, 10004.0)
        , (-360.0, -360.0, 0.0, 9800.0)
        )
