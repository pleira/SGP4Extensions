 ...
 * Also intermediate values used by the propagator models are include.
 *  
...
case class OtherCoefs[F : Field: NRoot : Order: Trig](ini: TEME.SGPElems[F], i0f : InclFunctions[F], e0f : EccentricityFunctions[F],
      bmmf: BrowerMeanMotion[F], sf : ScalcFunctions[F], coeff : CoefFunctions[F])(implicit wgs: SGPConstants[F]) {
